...
2. Generate relevant data visual plots that explore multicollinearity for the quantitative variables and normality for the quantitative variables as well. Also, use
...
area, year, quality, style, and lot statistically significant. This means that the Null Hypothesis are their coefficients are zero can be rejected in favor of the Alternative hypothesis
